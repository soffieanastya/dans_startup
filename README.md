...
terdapat 2 folder, ada DB-DANS-STARTUP (https://github.com/soffieanastya/db-dans.git) dan BE-DANS
...
Folder BE-DANS, berisi backend untuk penyelesaian test. terdapat beberapa folder, yaitu:
- auth (untuk login)
- joblist
- jobdetail

Cara menjalankannya:
1. di repo/folder yang sama, buka terminal lalu ketik: 
npm install

2. jalankan backend (nest js) dengan mengetikkan:
    - npm run start 
    - npm run start:dev
3. API dapat digunakan sesuai dengan kebutuhan
